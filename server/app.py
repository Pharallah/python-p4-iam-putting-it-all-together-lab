...
class Signup(Resource):
    def post(self):
        ...
        # We set this outside the constructor to trigger the @password_hash.setter (DIFFERENT )
...
class RecipeIndex(Resource):
    ...
    def post(self):
        ...
        # How do I check if a recipe is valid???
        # How do I check if a user(created) is not valid??
